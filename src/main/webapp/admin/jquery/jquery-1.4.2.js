...
// The value/s can be optionally by executed if its a function
    ...
    (function () {
        ...
        jQuery.support = {
            ...
            optSelected: document.createElement("select")
                                     ...
                                     if (elem.nodeType === 1) {
                                         if (!elem.className) {
                                             ...
                                             for (var c = 0, cl = classNames.length; c < cl; c++) {
                                                 if (className.indexOf(" " + classNames[c] + " ")
                                                     < 0) {
                         ...
                         toggleClass: function (value, stateVal) {
                             ...
                             return this.each(function () {
                                 if (type === "string") {
                                     ...
                                     this.className =
                                         this.className || value === false ? "" : jQuery.data(this,
                                                                                              "__className__")
                                                                                  || "";
                                 }
                             });
    ...
    jQuery.event = {
        ...
        trigger: function (event, data, elem /*, bubbling */) {
            ...
            if (!event.isPropagationStopped() && parent) {
                ...
                if ((!special._default || special._default.call(elem, event) === false) && !isClick
        ...
        handle: function (event) {
            ...
            if (!all) {
                ...
                namespace =
                    new RegExp("(^|\\.)" + namespaces.slice(0).sort().join("\\.(?:.*\\.)?")
                               + "(\\.|$)");
            }
        ...
        fix: function (event) {
            ...
            if (!event.target) {
                event.target = event.srcElement || document; // Fixes #1925 where srcElement might
            ...
            if (event.pageX == null && event.clientX != null) {
                ...
                event.pageX =
                    event.clientX + (doc && doc.scrollLeft || body && body.scrollLeft || 0) - (doc
                                                                                               && doc.clientLeft
                                                                                               || body
                                                                                                  && body.clientLeft
                                                                                               || 0);
            ...
            if (!event.which && ((event.charCode || event.charCode === 0) ? event.charCode
                    : event.keyCode)) {
            ...
            if (!event.which && event.button !== undefined) {
                event.which =
                    (event.button & 1 ? 1 : ( event.button & 2 ? 3 : ( event.button & 4 ? 2
                        : 0 ) ));
            }
...
// Create "bubbling" focus and blur events
    ...
    jQuery.fn.extend({
                         ...
                         toggle: function (fn) {
                             ...
                             return this.click(jQuery.proxy(fn, function (event) {
                                 ...
                                 var lastToggle = ( jQuery.data(this, "lastToggle" + fn.guid) || 0 )
                                                  % i;
    ...
    function liveHandler(event) {
        ...
        if (event.liveFired === this || !events || !events.live || event.button && event.type
                                                                                   === "click") {
            return;
        }
    ...
    function liveConvert(type, selector) {
        return "live." + (type && type !== "*" ? type + "." : "") + selector.replace(/\./g, "`")
                .replace(/ /g, "&");
    }
        ...
        var Expr = Sizzle.selectors = {
            ...
            filter: {
                ...
                TAG: function (elem, match) {
                    return (match === "*" && elem.nodeType === 1) || elem.nodeName.toLowerCase()
                                                                     === match;
                },
                         ...
                         index: function (elem) {
                             if (!elem || typeof elem === "string") {
                                 return jQuery.inArray(this[0],
                                                       // If it receives a string, the selector is
                                                       // used If it receives nothing, the siblings
                                                       // are used
                                                       elem ? jQuery(elem) : this.parent()
                                                           .children());
                             }
...
// IE can't serialize <link> and <script> tags normally
    ...
    function buildFragment(args, nodes, scripts) {
        ...
        if (args.length === 1 && typeof args[0] === "string" && args[0].length < 512 && doc
                                                                                        === document
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function (selector) {
            ...
            if (parent && parent.nodeType === 11 && parent.childNodes.length === 1 && insert.length
                                                                                      === 1) {
    ...
    jQuery.extend({
                      clean: function (elems, context, fragment, scripts) {
                          ...
                          if (typeof context.createElement === "undefined") {
                              context =
                                  context.ownerDocument || context[0] && context[0].ownerDocument
                                  || document;
                          }
                          ...
                          if (fragment) {
                              for (var i = 0; ret[i]; i++) {
                                  if (scripts && jQuery.nodeName(ret[i], "script") && (!ret[i].type
                                      ...
                                      if (ret[i].nodeType === 1) {
                                          ret.splice.apply(ret, [i + 1, 0].concat(jQuery.makeArray(
                      ...
                      style: function (elem, name, value) {
                          ...
                          if (!jQuery.support.opacity && name === "opacity") {
                              if (set) {
                                  ...
                                  style.filter =
                                      ralpha.test(filter) ? filter.replace(ralpha, opacity)
                                          : opacity;
                              }
                          ...
                          if (name === "width" || name === "height") {
                              ...
                              function getWH() {
                                  ...
                                  jQuery.each(which, function () {
                                      ...
                                      if (extra === "margin") {
                                          val +=
                                              parseFloat(jQuery.curCSS(elem, "margin" + this, true))
                                              || 0;
                                      } else {
                                          val -=
                                              parseFloat(
                                                  jQuery.curCSS(elem, "border" + this + "Width",
                                                                true)) || 0;
                                      }
                                  });
                              }
                                             ...
                                             complete: function (res, status) {
                                                 ...
                                                 if (status === "success" || status
                                                     ...
                                                     self.html(selector ?
                                                               ...
                                                               // document in, removing the scripts
    ...
    jQuery.extend({
                      ...
                      ajax: function (origSettings) {
                          ...
                          if (s.cache === false && type === "GET") {
                              ...
                              s.url =
                                  ret + ((ret === s.url) ? (rquery.test(s.url) ? "&" : "?") + "_="
                                  + ts : "");
                          }
                          ...
                          // Override the abort handler, if we can (IE doesn't allow it, but that's
                          // OK) Opera doesn't fire onreadystatechange at all on abort
                          try {
                          ...
                          try {
                              xhr.send(
                                  type === "POST" || type === "PUT" || type === "DELETE" ? s.data
                                      : null);
                          } catch (e) {
                              ...
                              if (jQuery.isArray(obj)) {
                                  ...
                                  jQuery.each(obj, function (i, v) {
                                      if (traditional || /\[\]$/.test(prefix)) {
                                          ...
                                          // its numeric index to resolve deserialization ambiguity
                                          // issues. Note that rack (as of 1.0.0) can't currently
                                          // deserialize nested arrays properly, and attempting to
                                          // do so may cause a server error. Possible fixes are to
                                          // modify rack's deserialization algorithm or to provide
                                          // an option or flag to force array serialization to be
                                          // shallow.
...
// Generate shortcuts for custom animations
    ...
    jQuery.extend({
                      speed: function (speed, easing, fn) {
                          ...
                          opt.duration =
                              jQuery.fx.off ? 0 : typeof opt.duration === "number" ? opt.duration :
        ...
        step: function (gotoEnd) {
            ...
            if (gotoEnd || t >= this.options.duration + this.startTime) {
                ...
                var defaultEasing = this.options.easing || (jQuery.easing.swing ? "swing"
                        : "linear");
                this.pos =
                    jQuery.easing[specialEasing || defaultEasing](this.state, n, 0, 1,
            ...
            _default: function (fx) {
                if (fx.elem.style && fx.elem.style[fx.prop] != null) {
                    fx.elem.style[fx.prop] =
                        (fx.prop === "width" || fx.prop === "height" ? Math.max(0, fx.now) : fx.now)
                        + fx.unit;
                } else {
    ...
    if ("getBoundingClientRect" in document.documentElement) {
        jQuery.fn.offset = function (options) {
            ...
            var box = elem.getBoundingClientRect(), doc = elem.ownerDocument, body = doc.body, docElem = doc.documentElement,
                ...
                top = box.top + (self.pageYOffset || jQuery.support.boxModel && docElem.scrollTop
                                 || body.scrollTop ) - clientTop,
                left = box.left + (self.pageXOffset || jQuery.support.boxModel && docElem.scrollLeft
        ...
        jQuery.fn.offset = function (options) {
            ...
            while ((elem = elem.parentNode) && elem !== body && elem !== docElem) {
                ...
                computedStyle =
                    defaultView ? defaultView.getComputedStyle(elem, null) : elem.currentStyle;
                top -= elem.scrollTop;
    ...
    jQuery.offset = {
        initialize: function () {
            var body = document.body, container = document.createElement(
                "div"), innerDiv, checkDiv, table, td, bodyMarginTop = parseFloat(
                    jQuery.curCSS(body, "marginTop", true)) || 0,
    ...
    jQuery.each(["Height", "Width"], function (i, name) {
        ...
        jQuery.fn[type] = function (size) {
            ...
            return ("scrollTo" in elem && elem.document) ? // does it walk and quack like a window?
                // Everyone else use document.documentElement or document.body depending on Quirks
                // vs Standards mode
